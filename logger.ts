/**
 * Core imports for state machine types and proof verification
 */
import { AgentState, Proof } from "./sm";

/**
 * ASCII art header template for log output
 * Displays system status, runtime info and verification data
 * @param status - Current operational status of the system ("ACTIVE" | "OFFLINE")
 ...
 */
export class StateMachineLogger implements StateLogger {
